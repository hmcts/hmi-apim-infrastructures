...
set JARPATH=%APP_HOME%\lib\hmi-apim-infrastructures.jar

@rem Execute hmi-apim-infrastructures
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HMI_APIM_INFRASTRUCTURES_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HMI_APIM_INFRASTRUCTURES_EXIT_CONSOLE%" exit 1
exit /b 1
